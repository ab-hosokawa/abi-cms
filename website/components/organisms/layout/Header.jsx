...
export default function Header() {
    ...
    return (<header className="bg-gray-700 text-white shadow-md">
            <div className="container mx-auto flex items-center justify-between py-4">
                {/* ロゴ */}
                <div className="text-2xl font-bold">
                    <a onClick={() => {
                        router.push('/');
                    }} aria-label="ホームページへ移動" className="hover:underline focus:outline-none focus:ring-2 focus:ring-yellow-400">MVP SITE</a>
                </div>
                {/* ハンバーガーメニュー（モバイル用） */}
                <button
