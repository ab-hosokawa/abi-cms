...
import { convertNewlineToBr } from '@/lib/utils/methods.js';
...
export default function DynamicPageStep2({ slug, data }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* 記事ヘッダー */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-4" dangerouslySetInnerHTML={{ __html: convertNewlineToBr(article['field.title']) }} />
      ...
      <article className="prose prose-lg max-w-none">
        ...
        {/* 記事の本文 */}
        <div className="mt-6" dangerouslySetInnerHTML={{ __html: convertNewlineToBr(article['field.comment']) }} />
      </article>
